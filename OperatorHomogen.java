 ...
 */
public class OperatorHomogen extends MatriksKonvolusiBerskala {
    public static final float [] a = {0,0,0,0,0,0,0,0,0};
    public OperatorHomogen(){
        super(a);
    }
    public OperatorHomogen(float[][] matriksKonvolusi) {
        super(matriksKonvolusi);
    }

    public OperatorHomogen(float[] floatArrayConstants) {
        super(floatArrayConstants);
    }

    public static final int numDifferences = 8;
    public static final int [] dx1 = {-1,0,1,-1,1,-1,0,1};
    public static final int [] dy1 = {-1,-1,-1,0,0,1,1,1};
    public static final int [] dx2 = {0,0,0,0,0,0,0,0};
    public static final int [] dy2 = {0,0,0,0,0,0,0,0};
