 ...
 */
public class EdgeDerajat1 extends MatriksKonvolusiBerskala{

    MatriksKonvolusi matriksKonvolusiArah [] = new MatriksKonvolusi[4];

    public EdgeDerajat1(float[][] matriksKonvolusi) {
        super(matriksKonvolusi);
        hitungMatriksKonvolusiArah();
    }

    public EdgeDerajat1(float[] floatArrayConstants) {
    ...
    public void hitungMatriksKonvolusiArah(){
        ...
        for (int i=0;i<4;i++){
            matriksKonvolusiTemp = matriksKonvolusiTemp.hasilPutarKiri();
